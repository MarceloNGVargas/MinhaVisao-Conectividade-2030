...
```mermaid
graph TD
    A["🏢 FASE 1: Grandes Operadoras<br/>Anos 90-2000<br/>Cobertura inicial, acesso discado e banda larga incipiente"] --> B["🏘️ FASE 2: Provedores Regionais<br/>2000-2010<br/>Expansão para cidades médias e pequenas"]
    B --> C["🏠 FASE 3: Pequenos Provedores Locais<br/>2010-2020<br/>Capilaridade com fibra e rádio rural"]
    C --> D["🌐 FASE 4: Grandes Players Globais<br/>2020-2030<br/>Satélite + Big Tech + IA<br/>Mobilidade, integração e escala planetária"]
    D -.-> |"O ciclo se fecha"| A
```
...
```mermaid
graph LR
    A["🛰️ FORÇA 1<br/>Satélite com Escala Global"] --> D["💀 MORTE DO<br/>PROVEDOR TRADICIONAL"]
    B["📱 FORÇA 2<br/>Integração Direta nos Devices"] --> D
    C["🧠 FORÇA 3<br/>IA Agentica + Simplicidade"] --> D
    
    A1["Starlink: 2.5M+ assinantes BR<br/>Kuiper: início operação 2026<br/>OneWeb: 600+ satélites<br/>Univity: 3100+ satélites"] -.-> A
    B1["TVs com chip satelital<br/>Carros com Starlink<br/>Celulares com 5G nativo<br/>IoT direto ao satélite"] -.-> B
    C1["Gemini Nano: 1.3GB no device<br/>Instalação virou commodity<br/>Celular = cérebro da rede<br/>Firewall e cache autônomos"] -.-> C
```
...
```mermaid
gantt
    title Linha do Tempo da Conectividade: 2026-2030
    dateFormat  YYYY
    axisFormat  %Y
    
    section Satélites
    Starlink domina mercado BR          :done, 2026, 1y
    Kuiper operação comercial           :active, 2026, 1y
    Constelações EU/China 5G LEO        :2027, 1y
    Univity 3100 satélites VLEO         :2027, 2y
    
    section Devices
    Chips satelitais em TVs e carros    :2027, 1y
    Gemini Nano/Mini embarcado          :2028, 1y
    Celular = cérebro da rede doméstica :2028, 1y
    Todos devices 5G nativos            :2029, 2y
    
    section Mercado
    Provedores perdem base urbana       :2026, 2y
    Fibra some como acesso final        :2027, 2y
    Casas inteligentes autônomas        :2028, 2y
    Fazendas conectadas via satélite    :2029, 2y
    Cenário Agentico consolidado        :2030, 1y
```
...
```mermaid
graph LR
    A["Provedor Tradicional<br/>Vende acesso à Internet"] --> |"Pivotamento"| B["Integrador Digital<br/>Vende soluções e ecossistemas"]
    A1["Instala rádio/fibra"] -.-> B1["Configura ecossistemas IoT"]
    A2["Competição em preço"] -.-> B2["Competição em valor agregado"]
    A3["Cliente dependente"] -.-> B3["Cliente autônomo + suporte especializado"]
```
